<div class="bp3-card bp3-elevation-2 col-md-8 offset-md-2 mt-5">
    ...
    ?>
    <form action="<?php echo WEBROOT . 'index.php/login'; ?>" method="post" class="mb-3 has-text-left">
        ...
        <div class="bp3-form-group"><label class="bp3-label" for="password">Enter your password : <span class="bp3-text-muted">(required)</span></label>
            <div class="bp3-form-content">
                <div class="bp3-input-group"><input type="password" name="password" placeholder="Password" required="" class="bp3-input" value="<?php if (isset($password)) {
                                                                                                                                                    echo $password;
                                                                                                                                                } ?>" style="padding-right: 10px;"></div>
            </div>
        ...
        <div class="has-text-right">
            <a href="/index.php/user/forgot_password">I forgot my password</a>
        </div>

        <p class="float-left">No account yet ? <a href="/index.php/register">Register</a></p>
        <button type="submit" class="bp3-button bp3-intent-primary col-md-2 offset-md-10" value="Submit"><span class="bp3-button-text">Login</span></button>
    </form>

    <a href="/index.php/login/google_login">
